...
import { FindOneResponse, DecreaseStockResponse, ProductServiceClient, PRODUCT_SERVICE_NAME, DecreaseStockRequest } from './proto/product';
...
export class OrderService implements OnModuleInit {
  ...
  public async createOrder(data: CreateOrderRequest): Promise<CreateOrderResponse> {
    ...
    const decreasedStockData: DecreaseStockResponse = await firstValueFrom(
        this.productSvc.decreaseStock({ id: data.productId, orderId: order.id } as DecreaseStockRequest),
